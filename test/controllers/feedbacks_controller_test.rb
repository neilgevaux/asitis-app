...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference("Feedback.count") do
      post feedbacks_url, params: { feedback: { body: @feedback.body, date: @feedback.date, happy: @feedback.happy } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { body: @feedback.body, date: @feedback.date, happy: @feedback.happy } }
